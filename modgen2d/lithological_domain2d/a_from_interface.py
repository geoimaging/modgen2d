...
class LithologicalDomain2D(LithologicalDomain2DReadOnly):
    ...
    lit_ids_expected : list[str]
        Expected lithological identifiers.
    lm_type : str
        Lithological model generation method/type.
    merged_lit : bool
        Indicates whether the domain was generated by merging
        multiple lithological domains.
    init_domain : DiscretizedDomain2D or None
        Original domain before remeshing.
    lit_order : list or None
        Ordering information for lithological units.
    obstruction2d_dict_list : list
        Metadata describing inserted obstructions.
    obstruction_overlap : str or None
        Obstruction overlap handling method.
    interface_config_revision_id : int
        Revision identifier of the interface configuration used
