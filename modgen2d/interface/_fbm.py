...
Code from https://github.com/crflynn/fbm/tree/master.

Only change:

For reproducibility,
> Added rng functionality on this. Sanish 4/6/2026 
> np.random -> self.rng
...
class FBM(object):
    ...
    def __init__(self, n, hurst, length=1, method="daviesharte", rng=None):
        """Instantiate the FBM."""
        ...
        # Added by Sanish (for reproducibility)
    ...
    def fgn(self):
        ...
        gn = self.rng.normal(0.0, 1.0, self.n)
    ...
    def _daviesharte(self, gn):
        ...
        #     processes in [0, 1] d." Journal of computational and graphical
        #     statistics 3, no. 4 (1994): 409-432.
        # if np.any([ev < 0 for ev in self._eigenvals]): Changed for efficiency - Sanish, suggested by GPT
        ...
        gn2 = self.rng.normal(0.0, 1.0, self.n)
