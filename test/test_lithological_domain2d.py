...
class TestLithologicalDomain2D(TestCase):
    def setUp(self):
        self.domain2D = modgen2d.discretized_interfaces2d.DiscretizedDomain2D(
        ...
        self.obs2D1 = modgen2d.obstruction2d.Obstruction2D(dl=0.5, ref_xz_symbolic=('0', 0), snap_to_dl=False)  #Should be same as above
        self.obs2D1.circle_2d(2, 1)

        self.obs2D2 = modgen2d.obstruction2d.Obstruction2D(dl=0.5, ref_xz_symbolic=('c', 0), snap_to_dl=False)  #Should be same as above
    ...
    def test_GSIConfig_set_soil_interface(self):
        ...
        # GeneralConfigTest
        glob_config = modgen2d.lithological_domain2d.GlobalSoilInterfaceConfig
        glob_config.reset()
        ...
        glob_config2 = modgen2d.lithological_domain2d.GlobalSoilInterfaceConfig
        self.assertAlmostEqual(glob_config.get_revision_id(), modgen2d.lithological_domain2d.GlobalSoilInterfaceConfig.get_revision_id())
        ...
        self.assertRaises(RuntimeError, modgen2d.lithological_domain2d.GlobalSoilInterfaceConfig.set_soil_interface, boundary2D, None)      
    
        with self.assertRaises(AttributeError):
            domain = modgen2d.lithological_domain2d.GlobalSoilInterfaceConfig._discretized_interface2d_instance.domain

        with self.assertRaises(AttributeError):
            modgen2d.lithological_domain2d.GlobalSoilInterfaceConfig._discretized_interface2d_instance = boundary2D
        
        with self.assertRaises(AttributeError):
            modgen2d.lithological_domain2d.GlobalSoilInterfaceConfig._discretized_interface2d_instance.domain = boundary2D.domain
    ...
    def test_lit_domain_interface(self):
        ...
        modgen2d.lithological_domain2d.GlobalSoilInterfaceConfig.reset()
        modgen2d.lithological_domain2d.GlobalSoilInterfaceConfig.set_soil_interface(boundary2D_hz)
        domain = modgen2d.lithological_domain2d.GlobalSoilInterfaceConfig.get_interface_instance().domain
        lit = modgen2d.lithological_domain2d.LithologicalDomain2D(domain, 1.8)
        lit_matrix = [['1', '2', '2', '4'],
                        ['1', '2', '2', '2'],
                        ['1', '1', '2', '3'],
                        ['1', '1', '2', '3'],
        ...
        modgen2d.lithological_domain2d.GlobalSoilInterfaceConfig.set_soil_interface(boundary2D, True)
        lit = modgen2d.lithological_domain2d.LithologicalDomain2D(domain, 1.8)
        ...
        modgen2d.lithological_domain2d.GlobalSoilInterfaceConfig.set_soil_interface(boundary2D_hz2, True)
        lit = modgen2d.lithological_domain2d.LithologicalDomain2D(domain, 1.8)
    ...
    def test_lit_domain_obs2d_and_merging(self):
        for setting in [1,2,3,4,5,6]:
            ...
            modgen2d.lithological_domain2d.GlobalSoilInterfaceConfig.reset()
            modgen2d.lithological_domain2d.GlobalSoilInterfaceConfig.set_soil_interface(boundary)
            
            domain2D_lit = modgen2d.discretized_domain2d.DiscretizedDomain2D(
                span_x=5, span_z=4, dx=boundary_dh, dz=boundary_dh
            )

            name = 'lit_domain1'
            lit = modgen2d.lithological_domain2d.LithologicalDomain2D(domain2D_lit, gwt_depth, name)

            domain2D_obs = modgen2d.discretized_domain2d.DiscretizedDomain2D(
            ...
            obs_lit = modgen2d.lithological_domain2d.LithologicalDomain2DFromObstruction2D(domain2D_obs, 'obst')
            ...
            lit = modgen2d.lithological_domain2d.LithologicalDomain2D(domain2D_lit, gwt_depth, name)
            obs_lit1 = modgen2d.lithological_domain2d.LithologicalDomain2DFromObstruction2D(domain2D_obs, 'obst')
            obs_lit1.add_obstruction2D(self.obs2D1, obs1_ref_point, 'U')

            obs_lit2 = modgen2d.lithological_domain2d.LithologicalDomain2DFromObstruction2D(domain2D_obs, 'obst')
